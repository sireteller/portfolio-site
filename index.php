  ...
  <body>
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="./projects.html" target="_blank"><i class="fas fa-file"></i><span>Web Projects</span></a></li>
                <li><a href="./art.html" target="_blank"><i class="fas fa-palette"></i><span>Art Showcase</span></a></li>
    ...
    <section class="contact">
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $conn = mysqli_connect("localhost", "root", "", "siret");
