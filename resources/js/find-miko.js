...
const winMsgArr = [document.getElementById('win-1'), document.getElementById('win-2'), document.getElementById('win-3'), document.getElementById('win-4'), document.getElementById('win-5'), document.getElementById('win-6'),document.getElementById('win-7'), document.getElementById('win-8')];
const winMiko1 = './resources/images/game/find-miko/mikoforsnowfull.png';
const winMiko2 = './resources/images/game/find-miko/mikoforforestfull.png';
const winMiko3 = './resources/images/game/find-miko/mikofortheaterfull.png';
const winMiko4 = './resources/images/game/find-miko/mikofortownfull.png';
const winMiko5 = './resources/images/game/find-miko/mikoforbeachfull.png';
